...
_Error.ShippoNotFoundError = ShippoError.extend({
  type: 'ShippoNotFoundError',
});
_Error.ShippoInvalidRequestError = ShippoError.extend({
  type: 'ShippoInvalidRequest',
});
_Error.ShippoAPIError = ShippoError.extend({ type: 'ShippoAPIError' });
_Error.ShippoAuthenticationError = ShippoError.extend({
  type: 'ShippoAuthenticationError',
});
_Error.ShippoConnectionError = ShippoError.extend({
  type: 'ShippoConnectionError',
});
